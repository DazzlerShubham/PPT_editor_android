...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView versionNumber = findViewById(R.id.appVersion);
        try {
            String version = getResources().getString(com.pdftron.demo.R.string.app_name) + getString(com.pdftron.demo.R.string.registered_trademark) + SettingsManager.getAppVersionName(this) + " (" + PDFNet.getVersion() + ")";
    ...
    private void openSimpleReaderActivity(boolean newUi) {
        ...
        builder = builder
                ...
                .annotationToolbarPosition(PdfViewCtrlTabHostFragment2.AnnotationToolbarPosition.TOP)
                .movableToolbarEnabled(true)
                .toolbarItemGravity(Gravity.START)
                .presetExpanding(true)
